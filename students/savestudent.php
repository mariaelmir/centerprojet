...
///////// file upload area
    ...
    $insert_query="insert into students(fullname,phone,email,educ_lvl,age,address,createdby,pic)
    values('".$name."',".$phone.",'".$email."','".$educ_lvl."',".$age.",'".$address."',".$user_id.",'".$targetFile."')";
    echo $insert_query ;
